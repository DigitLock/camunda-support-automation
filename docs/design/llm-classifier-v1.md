...
5.2 (LLM classify path with guardrails) and 5.3 (review loop, process v7; implemented and
accepted live, run `20260925T063333Z`) are done; 5.4 pending. Milestones
